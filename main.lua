-- HttpSpy v1.2.5 for AWP

if rconsoleprint then
    rconsoleprint("@wearebased on discord\n\n")
end
...
local version = "Https Spy Reborn"
...
local success, err = pcall(function()
    ...
    MinimizedIcon.Position = UDim2.new(0.5, -20, 0, 10)  -- Positioned at top center with 10px from top
